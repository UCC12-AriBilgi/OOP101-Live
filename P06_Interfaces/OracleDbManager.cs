...
{
    internal class OracleDbManager : IDatabase
    {
        private string value; // db tarafına gidecek/gelecek değer

        private string userName = "oracle"; // kullanıcı adı
        ...
        public void close()
        {
            Console.WriteLine("OracleDB bağlantısı başarılı bir şekilde sonlandırıldı...\n");
        }
        ...
        public void deletevalue()
        {
            ...
            Console.WriteLine("Veritabanı üzerindeki bilgilersilindi...\n");
        }
